...
namespace Swart_Simon_17611447_Task_1
{
    class RepairUnit : Unit
    {
        ...
        public RepairUnit(int X, int Y, int health, int speed, int attack, string faction, string symbol, string name)
        {
            xPosition = X;
            yPosition = Y;
            Health = health;
        ...
        public void loadRed()
        {
            ...
            inFile = new FileStream(@"Files\\redRepair.txt", FileMode.Open, FileAccess.Read);
